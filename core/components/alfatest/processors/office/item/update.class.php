 ...
 * Update an Item
 */
class alfatestOfficeItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('alfatest_item_err_ns');
		}
...
return 'alfatestOfficeItemUpdateProcessor';
