...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('alfatest_core_path', null, $modx->getOption('core_path') . 'components/alfatest/') . 'model/';
            $modx->addPackage('alfatest', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/alfatest/model/schema/alfatest.mysql.schema.xml';
